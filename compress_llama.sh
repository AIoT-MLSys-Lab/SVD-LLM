...
python SVDLLM.py --step 4 --model_path whitening/jeffwan_llama_7b_hf_whitening_0.2.pt
# evaluate the efficiency of llama_7b_whitening_0.2.pt
python SVDLLM.py --step 5 --model_path whitening/jeffwan_llama_7b_hf_whitening_0.2.pt